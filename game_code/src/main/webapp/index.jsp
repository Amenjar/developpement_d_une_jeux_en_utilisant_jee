...
<body class="center-all" style="color:white;background-color:black;">
	<h1>TP3 JEE Game devolopped By Amen</h1>
	...
	<form action="doGuess" name="guessForm" method="get">
		<div class="center-all" style="color:white;">
		...
		<div class="input-group w-25">
			...
			<div class="input-group-append">
		    	<button class="btn btn-outline-secondary" type="submit">running</button>
		  	</div>
		</div>	
...
<div class="table-responsive container" >
<h3>Table key</h3>
<table class="table table-bordered col align-self-center" style="width:650px; color:white;" >
	<tr width="15px">
    	<th scope="row" width="1px" class="bg-success"></th>
	       	<td style="color:white;" >Digit in it's correct position</td>
    </tr>
    
    <tr width="15px">
    	<th scope="row" width="1px" class="bg-warning"></th>
	       	<td style="color:white;">Digit exists in solution but in wrong place</td>
    </tr>
    
    <tr width="15px">
    	<th scope="row" width="1px" class=""></th>
	       	<td style="color:white;">Digit dosn't figure in the solution </td>
    </tr>
</table>
</div>
</c:if>
